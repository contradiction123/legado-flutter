...
_BookInfoRule _$BookInfoRuleFromJson(Map<String, dynamic> json) =>
    _BookInfoRule(
      ...
      relatedBooks: json['relatedBooks'] as String?,
    );

Map<String, dynamic> _$BookInfoRuleToJson(_BookInfoRule instance) =>
    <String, dynamic>{
      'init': instance.init,
      'name': instance.name,
